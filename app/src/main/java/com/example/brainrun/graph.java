            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    if(documentSnapshot.exists()){
                        ...
                        int maxAdamDays = Integer.parseInt(userData.getOrDefault("Max Playing with Graphs", "0").toString());
                        int minAdamDays = Integer.parseInt(userData.getOrDefault("Min Playing with Graphs", "0").toString());
                        int numberOfAttempts = Integer.parseInt(userData.getOrDefault("Number Of Attempts Playing with Graphs", "0").toString()) + 1;
                        int total = Integer.parseInt(userData.getOrDefault("Playing with Graphs Total", "0").toString()) + inf;
                        if(inf>maxAdamDays){
                            maxAdamDays = inf;
                        }
...
//                        @SuppressLint("DefaultLocale") String formattedAvg = String.format("%.2f", avg);
                        ...
                        user1.put("Playing with Graphs",String.valueOf(inf));
                        user1.put("Min Playing with Graphs", String.valueOf(minAdamDays));
                        user1.put("Max Playing with Graphs", String.valueOf(maxAdamDays));
                        user1.put("Number Of Attempts Playing with Graphs", String.valueOf(numberOfAttempts));
                        user1.put("Playing with Graphs Total", total);
