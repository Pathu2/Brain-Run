...
//                        john.super.onBackPressed();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_john2);
        ...
        String videoPath1 = "android.resource://" + getPackageName()+ "/" + R.raw.j2;
        ...
        String videoPath2 = "android.resource://" + getPackageName()+ "/" + R.raw.j1;
...
//        videoView2.start();
        ...
        String videoPath3 = "android.resource://" + getPackageName()+ "/" + R.raw.j3;
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    if(documentSnapshot.exists()){
                        ...
                        int maxAdamDays = Integer.parseInt(userData.getOrDefault("Max John and Norman", "0").toString());
                        int minAdamDays = Integer.parseInt(userData.getOrDefault("Min John and Norman", "0").toString());
                        int numberOfAttempts = Integer.parseInt(userData.getOrDefault("Number Of Attempts John and Norman", "0").toString()) + 1;
                        int total = Integer.parseInt(userData.getOrDefault("John and Norman Total", "0").toString()) + inf;
                        if(inf>maxAdamDays){
                            maxAdamDays = inf;
                        }
...
//                        @SuppressLint("DefaultLocale") String formattedAvg = String.format("%.2f", avg);
                        ...
                        user1.put("John and Norman",String.valueOf(inf));
                        user1.put("Min John and Norman", String.valueOf(minAdamDays));
                        user1.put("Max John and Norman", String.valueOf(maxAdamDays));
                        user1.put("Number Of Attempts John and Norman", String.valueOf(numberOfAttempts));
                        user1.put("John and Norman Total", total);
...
//        else { data5 = "0";}
//        Intent intent = new Intent(john.this, bscore4.class);
