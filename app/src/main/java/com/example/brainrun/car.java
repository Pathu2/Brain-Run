...
//                        car.super.onBackPressed();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String videoPath1 = "android.resource://" + getPackageName()+ "/" + R.raw.sc21;
        ...
        String videoPath2 = "android.resource://" + getPackageName()+ "/" + R.raw.sc22;
...
//        videoView2.start();
        ...
        String videoPath3 = "android.resource://" + getPackageName()+ "/" + R.raw.sc23;
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    if(documentSnapshot.exists()){
                        ...
                        int maxAdamDays = Integer.parseInt(userData.getOrDefault("Max Peter's Dilemma", "0").toString());
                        int minAdamDays = Integer.parseInt(userData.getOrDefault("Min Peter's Dilemma", "0").toString());
                        int numberOfAttempts = Integer.parseInt(userData.getOrDefault("Number Of Attempts Peter's Dilemma", "0").toString()) + 1;
                        int total = Integer.parseInt(userData.getOrDefault("Peter's Dilemma Total", "0").toString()) + inf;
                        if(inf>maxAdamDays){
                            maxAdamDays = inf;
                        }
...
//                        @SuppressLint("DefaultLocale") String formattedAvg = String.format("%.2f", avg);
                        ...
                        user1.put("Peter's Dilemma",String.valueOf(inf));
                        user1.put("Min Peter's Dilemma", String.valueOf(minAdamDays));
                        user1.put("Max Peter's Dilemma", String.valueOf(maxAdamDays));
                        user1.put("Number Of Attempts Peter's Dilemma", String.valueOf(numberOfAttempts));
                        user1.put("Peter's Dilemma Total", total);
        ...
        finish();
//        Intent intent = new Intent(car.this, cscore2.class);
