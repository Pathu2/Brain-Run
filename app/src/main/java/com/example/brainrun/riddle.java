            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    if(documentSnapshot.exists()){
                        ...
                        int maxAdamDays = Integer.parseInt(userData.getOrDefault("Max Riddles", "0").toString());
                        int minAdamDays = Integer.parseInt(userData.getOrDefault("Min Riddles", "0").toString());
                        int numberOfAttempts = Integer.parseInt(userData.getOrDefault("Number Of Attempts Riddles", "0").toString()) + 1;
                        int total = Integer.parseInt(userData.getOrDefault("Riddles Total", "0").toString()) + inf;
                        if(inf>maxAdamDays){
                            maxAdamDays = inf;
                        }
...
//                        @SuppressLint("DefaultLocale") String formattedAvg = String.format("%.2f", avg);
                        ...
                        user1.put("Riddles",String.valueOf(inf));
                        user1.put("Min Riddles", String.valueOf(minAdamDays));
                        user1.put("Max Riddles", String.valueOf(maxAdamDays));
                        user1.put("Number Of Attempts Riddles", String.valueOf(numberOfAttempts));
                        user1.put("Riddles Total", total);
