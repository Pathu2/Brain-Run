...
//                        school.super.onBackPressed();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String videoPath1 = "android.resource://" + getPackageName()+ "/" + R.raw.s1;
        ...
        String videoPath2 = "android.resource://" + getPackageName()+ "/" + R.raw.s2;
...
//        videoView2.start();
        ...
        String videoPath3 = "android.resource://" + getPackageName()+ "/" + R.raw.s3;
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    if(documentSnapshot.exists()){
                        ...
                        int maxAdamDays = Integer.parseInt(userData.getOrDefault("Max Chaos at School", "0").toString());
                        int minAdamDays = Integer.parseInt(userData.getOrDefault("Min Chaos at School", "0").toString());
                        int numberOfAttempts = Integer.parseInt(userData.getOrDefault("Number Of Attempts Chaos at School", "0").toString()) + 1;
                        int total = Integer.parseInt(userData.getOrDefault("Chaos at School Total", "0").toString()) + inf;
                        if(inf>maxAdamDays){
                            maxAdamDays = inf;
                        }
...
//                        @SuppressLint("DefaultLocale") String formattedAvg = String.format("%.2f", avg);
                        ...
                        user1.put("Chaos at School",String.valueOf(inf));
                        user1.put("Min Chaos at School", String.valueOf(minAdamDays));
                        user1.put("Max Chaos at School", String.valueOf(maxAdamDays));
                        user1.put("Number Of Attempts Chaos at School", String.valueOf(numberOfAttempts));
                        user1.put("Chaos at School Total", total);
        ...
        finish();
//        Intent intent = new Intent(school.this, cscore1.class);
