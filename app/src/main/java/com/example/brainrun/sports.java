            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    if(documentSnapshot.exists()){
                        ...
                        int maxAdamDays = Integer.parseInt(userData.getOrDefault("Max Football Match", "0").toString());
                        int minAdamDays = Integer.parseInt(userData.getOrDefault("Min Football Match", "0").toString());
                        int numberOfAttempts = Integer.parseInt(userData.getOrDefault("Number Of Attempts Football Match", "0").toString()) + 1;
                        int total = Integer.parseInt(userData.getOrDefault("Football Match Total", "0").toString()) + inf;
                        if(inf>maxAdamDays){
                            maxAdamDays = inf;
                        }
...
//                        @SuppressLint("DefaultLocale") String formattedAvg = String.format("%.2f", avg);
                        ...
                        user1.put("Football Match",String.valueOf(inf));
                        user1.put("Min Football Match", String.valueOf(minAdamDays));
                        user1.put("Max Football Match", String.valueOf(maxAdamDays));
                        user1.put("Number Of Attempts Football Match", String.valueOf(numberOfAttempts));
                        user1.put("Football Match Total", total);
