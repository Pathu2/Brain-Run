            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    if(documentSnapshot.exists()){
                        ...
                        int maxAdamDays = Integer.parseInt(userData.getOrDefault("Max Sunday's Game", "0").toString());
                        int minAdamDays = Integer.parseInt(userData.getOrDefault("Min Sunday's Game", "0").toString());
                        int numberOfAttempts = Integer.parseInt(userData.getOrDefault("Number Of Attempts Sunday's Game", "0").toString()) + 1;
                        int total = Integer.parseInt(userData.getOrDefault("Sunday's Game Total", "0").toString()) + inf;
                        if(inf>maxAdamDays){
                            maxAdamDays = inf;
                        }
...
//                        @SuppressLint("DefaultLocale") String formattedAvg = String.format("%.2f", avg);
                        ...
                        user1.put("Sunday's Game",String.valueOf(inf));
                        user1.put("Min Sunday's Game", String.valueOf(minAdamDays));
                        user1.put("Max Sunday's Game", String.valueOf(maxAdamDays));
                        user1.put("Number Of Attempts Sunday's Game", String.valueOf(numberOfAttempts));
                        user1.put("Sunday's Game Total", total);
