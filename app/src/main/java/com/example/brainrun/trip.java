...
//                        trip.super.onBackPressed();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String videoPath1 = "android.resource://" + getPackageName()+ "/" + R.raw.sv31;
        ...
        String videoPath2 = "android.resource://" + getPackageName()+ "/" + R.raw.sv32;
...
//        videoView2.start();
        ...
        String videoPath3 = "android.resource://" + getPackageName()+ "/" + R.raw.sv33;
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    if(documentSnapshot.exists()){
                        ...
                        int maxAdamDays = Integer.parseInt(userData.getOrDefault("Max Ben's Trip", "0").toString());
                        int minAdamDays = Integer.parseInt(userData.getOrDefault("Min Ben's Trip", "0").toString());
                        int numberOfAttempts = Integer.parseInt(userData.getOrDefault("Number Of Attempts Ben's Trip", "0").toString()) + 1;
                        int total = Integer.parseInt(userData.getOrDefault("Ben's Trip Total", "0").toString()) + inf;
                        if(inf>maxAdamDays){
                            maxAdamDays = inf;
                        }
...
//                        @SuppressLint("DefaultLocale") String formattedAvg = String.format("%.2f", avg);
                        ...
                        user1.put("Ben's Trip",String.valueOf(inf));
                        user1.put("Min Ben's Trip", String.valueOf(minAdamDays));
                        user1.put("Max Ben's Trip", String.valueOf(maxAdamDays));
                        user1.put("Number Of Attempts Ben's Trip", String.valueOf(numberOfAttempts));
                        user1.put("Ben's Trip Total", total);
        ...
        finish();
//        Intent intent = new Intent(trip.this, cscore3.class);
