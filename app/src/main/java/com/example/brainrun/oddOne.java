            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    if(documentSnapshot.exists()){
                        ...
                        int maxAdamDays = Integer.parseInt(userData.getOrDefault("Max Odd One Out", "0").toString());
                        int minAdamDays = Integer.parseInt(userData.getOrDefault("Min Odd One Out", "0").toString());
                        int numberOfAttempts = Integer.parseInt(userData.getOrDefault("Number Of Attempts Odd One Out", "0").toString()) + 1;
                        int total = Integer.parseInt(userData.getOrDefault("Odd One Out Total", "0").toString()) + inf;
                        if(inf>maxAdamDays){
                            maxAdamDays = inf;
                        }
...
//                        @SuppressLint("DefaultLocale") String formattedAvg = String.format("%.2f", avg);
                        ...
                        user1.put("Odd One Out",String.valueOf(inf));
                        user1.put("Min Odd One Out", String.valueOf(minAdamDays));
                        user1.put("Max Odd One Out", String.valueOf(maxAdamDays));
                        user1.put("Number Of Attempts Odd One Out", String.valueOf(numberOfAttempts));
                        user1.put("Odd One Out Total", total);
